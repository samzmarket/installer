...
echo -e "\033[32mWHATSAPP  : 6285136825418\033[0m"
echo -e "\033[31mYOUTUBE : SAMZ MARKET\033[0m"
echo ""
...
REPO_URL="https://github.com/samzmarket/installer"
TEMP_DIR="installer"
...
echo -e "${GREEN}Installing ${YELLOW}sudo${GREEN} if not installed${RESET}"
    ...
    1)
        ...
        GITHUB_TOKEN="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"
...
;;
     7)
# Default URL gambar
DEFAULT_URL="https://files.catbox.moe/k8uo25.jpg"
